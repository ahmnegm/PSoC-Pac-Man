...
*
* \funcusage
*  \snippet HSYNC_OUT_SUT.c usage_HSYNC_OUT_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet HSYNC_OUT_SUT.c usage_HSYNC_OUT_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet HSYNC_OUT_SUT.c usage_HSYNC_OUT_Read  
*******************************************************************************/
...
* preferred HSYNC_OUT_Read() API because the 
* HSYNC_OUT_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet HSYNC_OUT_SUT.c usage_HSYNC_OUT_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: HSYNC_OUT_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use HSYNC_OUT_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - HSYNC_OUT_0_INTR       (First pin in the list)
    *  - HSYNC_OUT_1_INTR       (Second pin in the list)
    *  - ...
    *  - HSYNC_OUT_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet HSYNC_OUT_SUT.c usage_HSYNC_OUT_SetInterruptMode
    *******************************************************************************/
    void HSYNC_OUT_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & HSYNC_OUT_0_INTR) != 0u) 
		{ 
			 HSYNC_OUT_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet HSYNC_OUT_SUT.c usage_HSYNC_OUT_ClearInterrupt
    *******************************************************************************/
